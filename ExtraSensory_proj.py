...
def to_array(watch_acc_df):
    ...
    # watch_acc_df_xaxis = list(np.array(watch_acc_df['x-axis']))
    # watch_acc_df_yaxis = list(np.array(watch_acc_df['y-axis']))
    # watch_acc_df_zaxis = list(np.array(watch_acc_df['z-axis']))
...
# path_uuid = '/NAS/home01/shiya/project data/cv_5_folds'
# path_label = '/NAS/home01/shiya/project data/ExtraSensory/'
# path_data = '/NAS/home01/shiya/project data/watch_acc/'
# result_filename = '/NAS/home01/shiya/project data/results.txt'
